...
v4 adds Galleys (folder-based, lifecycle with optional queue), focus & optimise, parallel workflow (worktrees, one Executor per galley), and the agent contract (`_agent-rules.md` + `AGENTS.md`). See [v4](v4.md) and [Galleys](galleys.md).
