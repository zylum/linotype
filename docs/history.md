...
What wasn’t obvious then: that experience was building the mental model later needed for AI agents. The same patterns that kept a complex system coherent with dozens of junior engineers would become Linotype—a way to keep products coherent when AI agents move faster than human understanding.
